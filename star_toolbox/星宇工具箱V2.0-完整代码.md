...
> 设备相关功能需安装 adb 并加入 PATH；串口功能依赖 pyserial。
...
- [`app/theme.py`](#-appthemepy)
- [`app/core/__init__.py`](#-appcoreinitpy)
- [`app/core/config_manager.py`](#-appcoreconfigmanagerpy)
- [`app/core/adb_manager.py`](#-appcoreadbmanagerpy)
- [`app/core/serial_manager.py`](#-appcoreserialmanagerpy)
- [`app/ui/__init__.py`](#-appuiinitpy)
- [`app/ui/log_panel.py`](#-appuilogpanelpy)
- [`app/ui/device_panel.py`](#-appuidevicepanelpy)
- [`app/ui/action_panel.py`](#-appuiactionpanelpy)
- [`app/ui/footer.py`](#-appuifooterpy)
- [`app/ui/main_window.py`](#-appuimainwindowpy)
- [`app/ui/dialogs.py`](#-appuidialogspy)
